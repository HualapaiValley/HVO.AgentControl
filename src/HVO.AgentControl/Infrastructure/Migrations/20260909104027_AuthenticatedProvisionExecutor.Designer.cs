...
namespace HVO.AgentControl.Infrastructure.Migrations
{
    ...
    [Migration("20260909104027_AuthenticatedProvisionExecutor")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HVO.AgentControl.Core.HostResourceReservation", b =>
                {
                    ...
                    b.Property<string>("EffectObservationId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("EffectObservationId");
            ...
            modelBuilder.Entity("HVO.AgentControl.Provisioning.ProvisionAttemptRecord", b =>
                {
                    ...
                    b.Property<int>("ExecutorAuthorityGeneration")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<long>("ReservationGrantGeneration")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("HVO.AgentControl.Provisioning.ProvisionEffectRecord", b =>
                {
                    ...
                    b.HasIndex("ReservationId", "Effect")
                        .IsUnique()
            ...
            modelBuilder.Entity("HVO.AgentControl.Provisioning.ProvisionExecutorReportRecord", b =>
                {
                    ...
                    b.HasIndex("OperationId", "ClaimGeneration", "Sequence")
                        .IsUnique();

                    b.HasIndex("OperationId", "ClaimGeneration", "Kind", "Sequence");

                    b.ToTable("ProvisionExecutorReports");
                });
            ...
            modelBuilder.Entity("HVO.AgentControl.Provisioning.ProvisionOperationRecord", b =>
                {
                    ...
                    b.Property<long>("LastAppliedResultSequence")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("SelectedAuthorityGeneration")
                        .HasColumnType("INTEGER");

                    b.Property<string>("SelectedEnrollmentId")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("SelectedIncarnationId")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<long?>("TerminalSuccessAt")
                        .HasColumnType("INTEGER");

                    b.Property<long?>("TerminalSuccessSequence")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("HVO.AgentControl.Core.HostResourceReservation", b =>
                {
                    b.HasOne("HVO.AgentControl.Core.HostResourceObservation", null)
                        .WithMany()
                        .HasForeignKey("EffectObservationId")
                        .OnDelete(DeleteBehavior.Restrict);
