...
builder.Services.AddSingleton<SshRuntimeTransportFactory>();
builder.Services.AddSingleton<IRuntimeTransportFactory, HVO.AgentControl.OpenCode.RuntimeTransportFactory>();
builder.Services.AddSingleton<ControlServiceRegistration>();
