...
public sealed class OrientationApiRuntimeTests : IClassFixture<EnabledRuntimeFactory>
{
    ...
    [Fact]
    public async Task MalformedLiveResponseEndpointReturns422WithoutComprehension()
    {
        ...
        Assert.Equal(OrientationStates.Delivered, factory.Host.GetOrientationStatus().State);
    }
