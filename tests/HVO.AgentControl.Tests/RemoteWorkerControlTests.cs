...
public sealed class RemoteWorkerControlTests
{
    ...
    [Fact]
    public void FreshSchemaIsV7AndCarriesRemoteWorkerAndHiringTablesWithoutSeededEnrollment()
    {
